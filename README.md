<h1> AC 230V light dimmer </h1>
<p> The aim of this repository is to introduce my latest "project" for a job interview.  <br>
For more information contact me: </p>
<ul>
  <li>Name: Filip Paul</li>
  <li>mob: +420 734 312 604</li>
  <li>email: filip.paul@email.cz</li>
</ul>
<h2> Functionality </h2>
<p> 
This device can dim the lights according to the position of the potentiometer. It can be also controlled remotely via Wifi with help of mobile app.</p>
...
<p> Scheme and PCB layout were created in EasyEDA environment, mainly because it is a relatively simple project. For more complex projects I'm able to work with Solidworks PCB (it is similar to Altium, but for me, it has better connectivity with SOLIDWORKS, which I use for 3D printed casings. <p><br>
...
<img src = "https://github.com/FilipPaul/AC-Light-dimmer/blob/master/pictures/wall.PNG" ><br>

<img src = "https://github.com/FilipPaul/AC-Light-dimmer/blob/master/pictures/wall1.PNG" ><br>
